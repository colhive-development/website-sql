...
import { Activity, IProject, Task, UserWithRole, Risk, File, Comment } from '@/lib/types';
...
export default function AdminProjectPage() {
  const project: IProject = {
    ...
    comments: [
      ...
      { id: "2", text: "I have some concerns about the budget.", author: { id: "1", name: "John Doe", email: "john@example.com", image: "/placeholder.svg", role: 'admin', emailVerified: false, companyId: "1" } }
    ]
  }
